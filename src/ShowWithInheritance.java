...
public class ShowWithInheritance
{
	public static int RUN_CASE = 1; // change this to try different behaviors
										// below
	...
	public static void main(String[] args)
	{
		...
		checkmate die1 = new checkmate();
		CrookedCheckmate1 crooked1 = new CrookedCheckmate1();
		CrookedCheckmate2 crooked2 = new CrookedCheckmate2();

		StdOut.println();

		// change RUN_EXAMPLE above to run any one of the following 6 examples

		allPossibilities(die1, crooked1, crooked2);

		StdOut.println();
	}

	private static void allPossibilities(checkmate die1, CrookedCheckmate1 crooked1, CrookedCheckmate2 crooked2)
	{
		if (RUN_CASE == 1)
		{
		...
		else if (RUN_CASE == 4)
		{
			...
			checkmate alias = crooked1; // upcasting!
	...
	public static void describe(String msg, checkmate toDescribe)
	{
